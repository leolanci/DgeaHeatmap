...
output: 
  BiocStyle::html_document:
    toc: true
  vignette: >
    %\VignetteIndexEntry{DgeaHeatmap Vignette}
...
```{r loadingPackagesNanostringData, eval=requireNamespace("GeoMxWorkflows", quietly = TRUE), warning=FALSE, include=FALSE, results='hide'}
...
SampleAnnotationFile <-
  dir(file.path(datadir, "annotation"),
    pattern = ".xlsx$",
    full.names = TRUE, recursive = TRUE
  )
```
...
path_metadata <- system.file("extdata", "MetaDataPackageNanostring.rds", package = "DgeaHeatmap")
coldata_2 <- readRDS(path_metadata)
