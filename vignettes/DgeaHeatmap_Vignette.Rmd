...
```{r PerformingDEGLimmaVoomfct,echo=TRUE, include=TRUE, error=TRUE, warning=FALSE}
...
```{r PerformingDEGDESeq2fct,echo=TRUE, include=TRUE, error=TRUE, warning=FALSE}
comparisons <- list(
...
```{r DESeq2_Venn_upreg, warning=FALSE}
library(ggvenn)
...
```{r DEA_Venn_edgeR, warning=FALSE}
...
```{r extractionNormalizedCounts, echo=FALSE, warning=FALSE, results='hide'}
library(data.table)
