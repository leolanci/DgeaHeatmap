...
The process of doing a differential gene expression analysis starts by checking if all the columns of the raw data are present in the metadata and if the column names appear in the same order in both the raw data and metadata.
